...
export default function GadgetDetailPage() {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        ...
        // Verify it's a gadget
        if (data.category !== "Gadget") {
          throw new Error("This is not a gadget product");
        }
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            {error || "The gadget you are looking for does not exist."}
          </p>
          <Link
            href="/gadgets"
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Breadcrumbs - Updated for gadgets */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <nav className="flex" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2 text-sm text-gray-500">
            ...
            <li>
              <Link href="/gadgets" className="hover:text-gray-700">
                Gadgets
              </Link>
            </li>
            <li>
      ...
      {/* Main product section - Same structure but with gadget-specific details */}
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-8">
          ...
          {/* Product info - With gadget-specific additions */}
