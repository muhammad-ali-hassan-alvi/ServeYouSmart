...
export default function ProductDetailsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Navigation - Same as in your Products component */}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="lg:grid lg:grid-cols-2 lg:gap-x-8">
          ...
          <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
            ...
            {/* Rating and stock status - only show if rating exists */}
            <div className="mt-4">
              <div className="flex items-center">
                {product.rating ? (
                  <>
            ...
            {/* Price display - simplified since sample data doesn't have discount */}
            <div className="mt-6">
            ...
            {/* Product options */}
            <form className="mt-8">
              {/* Color picker - only show if colors exist */}
              ...
              {/* Size picker - only show if sizes exist */}
